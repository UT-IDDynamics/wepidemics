...
1.  The impact of long-term nonpharmaceutical interventions on COVID-19
...
1.  Hierarchical Modeling for Diagnostic Test Accuracy Using
    ...
    [CopulaREMADA
    (R)](https://cran.r-project.org/web/packages/CopulaREMADA/index.html))
2.  Diagnostic test accuracy network meta-analysis methods: A scoping
...
1.  Diagnostic test accuracy network meta-analysis methods: A scoping
    review and empirical assessment [(**link**)](entries/NMADiagT.md)
    (*software*: [CopulaDTA
    (R)](https://cran.r-project.org/web/packages/CopulaDTA/index.html),
    [mada (R)](https://cranr-projectorg/web/packages/mada/indexhtml),
